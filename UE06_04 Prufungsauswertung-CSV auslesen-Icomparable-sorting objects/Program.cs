...
class Program
{
    static void Main(string[] args)
    {
        ...
        string[] lines = System.IO.File.ReadAllLines(@"C:\Users\Paul Trautner\Desktop\Ingenieurinformatik 2\Visualstudio-projects\UE06_04 Prufungsauswertung-CSV auslesen-Icomparable-sorting objects\UE06-BSP04_Students.csv");
